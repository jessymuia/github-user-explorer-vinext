import { a as stripBasePath, n as toBrowserNavigationHref, r as toSameOriginAppPath } from "./assets/url-utils-BKwNM2eZ.js";
...
var client_references_default = {
	"cbd92ab4df0f": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_cbd92ab4df0f;
	},
	"a9bbde40cf2d": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_a9bbde40cf2d;
	},
	"56bba47f6a03": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_56bba47f6a03;
	},
	"51d01d201116": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_51d01d201116;
	},
	"f0c285f7e4e6": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_f0c285f7e4e6;
	},
	"5022a32106f3": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_5022a32106f3;
	},
	"bb5b54ebadbb": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_bb5b54ebadbb;
	},
	"e7b4dc739728": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_e7b4dc739728;
	},
	"bccf86c93377": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_bccf86c93377;
	},
	"0974d08b1f02": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_0974d08b1f02;
	},
	"f29e6e234fea": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_f29e6e234fea;
	},
	"0deffcb8ffd7": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_0deffcb8ffd7;
	},
	"c2747888630f": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-CghtCZRB.js")).export_c2747888630f;
	}
};
//#endregion
...
var navigation_exports = /* @__PURE__ */ __exportAll({
	...
	getPrefetchCache: () => getPrefetchCache,
	getPrefetchedUrls: () => getPrefetchedUrls,
	setNavigationContext: () => setNavigationContext,
	storePrefetchResponse: () => storePrefetchResponse,
	toRscUrl: () => toRscUrl,
...
var _clientRefsPreloaded = false;
/**
...
async function handleSsr(rscStream, navContext, fontData) {
	if (!_clientRefsPreloaded && client_references_default && globalThis.__vite_rsc_client_require__) {
		await Promise.all(Object.keys(client_references_default).map((id) => globalThis.__vite_rsc_client_require__(id).catch((err) => {})));
...
//#endregion
export { usePathname as a, _virtual_vinext_app_ssr_entry_default as default, handleSsr, toRscUrl as i, getPrefetchedUrls as n, useRouter as o, storePrefetchResponse as r, useSearchParams as s, getLayoutSegmentContext as t };
